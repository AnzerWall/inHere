/**
 * Created by LisaChan on 2016/9/24.
 */
;!function (win) {
  ...
  sCss += '.sim-pop-close{width: 40px;height: 50px;line-height: 50px;text-align: center;font-size: 36px;position: absolute;right: 0;top: 0;color: rgba(0,0,0,0.5);-webkit-transition: -webkit-transform 0.18s;transition: transform 0.18s;}';
  sCss += '.sim-pop-close:focus,.sim-pop-close:hover,.sim-pop-close:active{color: rgba(0,0,0,0.4);-webkit-transform: rotate(90deg);transform: rotate(90deg);}';
